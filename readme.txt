...
WARNING: PostEvent repository have changed. To get the last version please follow the link: http://wordpress.org/extend/plugins/post-event2/
...
This plugin will be located in the WordPress plugin folder and activated from the admin panel.
    ...
    * Download the plugin here: http://wordpress.org/extend/plugins/post-event,
...
WARNING: You must have at least php5 ! Otherwise you will have an parse error !
