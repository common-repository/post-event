...
Testé sur la version: 2.8.5
Tag stable: 2.2

== Introduction ==

ATTENTION: Le depot de PostEvent a change. Pour obtenir la derniere version, merci de suivre ce lien: http://wordpress.org/extend/plugins/post-event2/
...
Ce plugin doit etre place dans le dossier de plugin de wordpress et doir etre activer par la panneau d'administration.
    ...
    * Telecharger le plugin ici: http://wordpress.org/extend/plugins,
...
* Pour récupérer le "fulx" ical d'un catégorie en particulier, allez dans cette categorie et ajouter "ical" aprés le "/" dans la barre d'adresse
